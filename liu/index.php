...
<div class="navbar navbar-fixed-top navbar-inverse">
    ...
    <div id="navbar" class="collapse navbar-collapse" role="navigation">
        <ul class="nav navbar-nav navbar-responsive-collapser">
            ...
            <li class="active"><a href="http://localhost/php/PHPtheway/liu/index.php">开奖查询</a></li>
            <li><a href="http://localhost/php/PHPtheway/liu/more.php">开奖记录</a></li>
        ...
        <div class="col-xs-12 col-md-12 col-lg-12" >              
            <div class="list-group">
                ...
                <form id="input" method="get" style="margin-top: 20px;">
                    ...
                    <div>
                        <label>特码查询:</label>
                        <input class="input" style="width: 100%;margin-bottom: 20px"" name="word2"
                        placeholder="输入特码，如：1-49">
                    </div>
                    <div>
